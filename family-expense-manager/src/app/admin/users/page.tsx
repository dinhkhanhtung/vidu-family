...
import { Search, Filter, Download, UserPlus, MoreHorizontal, Shield, ShieldCheck, Crown } from "lucide-react"
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage users, subscriptions, and monitor user activities
          </p>
        </div>
